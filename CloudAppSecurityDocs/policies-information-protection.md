...
4. 省略可能: 違反が検出されたときにファイルに対して実行される**ガバナンス**アクションを設定します。 使用できるガバナンスアクションは、サービスによって異なります。 次に例を示します。
...
2. [**セッション制御の種類**] で、[**ファイルのダウンロードを制御する (検査あり)**] を選択します。
...
2. [**セッション制御の種類**] で、[**ファイルのアップロードを制御する (検査付き)** ] または [**ファイルのダウンロードを制御する (検査あり)**] を選択します。
